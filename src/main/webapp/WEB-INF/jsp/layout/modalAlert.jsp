              ...
              <div class="row">
                <div class="col-lg-6 col-12">
                  <div class="modal-product-img">
                    <img
                      src="${pageContext.request.contextPath}/assets/img/product/4.png"
                      alt="#"
                    />
                  </div>
                </div>
            ...
            <div class="modal-product-item">
              <div class="row">
                <div class="col-12">
                  <div class="modal-product-img">
                    <img
                      src="${pageContext.request.contextPath}/assets/img/product/1.png"
                      alt="#"
                    />
                  </div>
                  <div class="modal-product-info">
                    ...
                    <p class="added-cart">
                      <i class="fa fa-check-circle"></i> Successfully added to
                      your Cart
                    </p>
                  ...
                  <div class="additional-info d-none">
                    ...
                    <div class="payment-method">
                      <img
                        src="${pageContext.request.contextPath}/assets/img/icons/payment.png"
                        alt="#"
                      />
                    </div>
                  </div>
            ...
            <div class="modal-product-item">
              <div class="row">
                <div class="col-12">
                  <div class="modal-product-img">
                    <img
                      src="${pageContext.request.contextPath}/assets/img/product/7.png"
                      alt="#"
                    />
                  </div>
                  <div class="modal-product-info">
